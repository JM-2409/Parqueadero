                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-slate-900 text-lg flex flex-col sm:flex-row sm:items-center sm:gap-2">
                      ...
                      <span className="text-slate-500 sm:text-slate-900 text-sm sm:text-lg">
            ...
            <div className="px-6 py-5 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
              <div>
                <h2 className="text-2xl font-black text-slate-900 flex flex-col sm:flex-row sm:items-center sm:gap-2">
                  <span>Revista del {new Date(selectedSession.start_time).toLocaleDateString("es-CO")}</span>
                  <span className="hidden sm:inline">-</span>
                  <span className="text-slate-500 sm:text-slate-900 text-lg sm:text-2xl">
