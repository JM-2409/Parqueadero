        ...
        <section className="relative pt-24 pb-32 overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link
                href="/login"
                className="w-full sm:w-auto px-8 py-4 bg-indigo-600 hover:bg-indigo-700 text-white text-lg font-medium rounded-2xl shadow-lg shadow-indigo-200 transition-all hover:shadow-xl hover:-translate-y-0.5"
              >
                Comenzar Ahora
              </Link>
              <a
                href="#contact"
                className="w-full sm:w-auto px-8 py-4 bg-white hover:bg-slate-50 text-slate-700 text-lg font-medium rounded-2xl shadow-sm border border-slate-200 transition-all hover:shadow-md"
              >
                Contactar Ventas
              </a>
            </div>
        ...
        <section id="features" className="py-24 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-slate-600 max-w-2xl mx-auto">Nuestra plataforma está diseñada para simplificar la operación diaria y maximizar la rentabilidad de tus parqueaderos.</p>
            </div>
            <div className="grid md:grid-cols-3 gap-8">
              <div className="p-8 rounded-3xl bg-slate-50 border border-slate-100 hover:shadow-lg transition-shadow">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">Múltiples Sedes</h3>
                <p className="text-slate-600 leading-relaxed">Gestiona varios parqueaderos desde una sola cuenta. Asigna administradores y empleados específicos para cada ubicación.</p>
              </div>
              <div className="p-8 rounded-3xl bg-slate-50 border border-slate-100 hover:shadow-lg transition-shadow">
                <div className="w-14 h-14 bg-emerald-100 text-emerald-600 rounded-2xl flex items-center justify-center mb-6">
                  <Clock size={28} />
                </div>
                <h3 className="text-xl font-bold text-slate-900 mb-3">Tarifas Dinámicas</h3>
                <p className="text-slate-600 leading-relaxed">Configura tarifas por fracción, hora, día o mensualidad. Soporte para tarifas diferenciadas de día y de noche.</p>
              </div>
              <div className="p-8 rounded-3xl bg-slate-50 border border-slate-100 hover:shadow-lg transition-shadow">
                <div className="w-14 h-14 bg-purple-100 text-purple-600 rounded-2xl flex items-center justify-center mb-6">
                  <ShieldCheck size={28} />
                </div>
                <h3 className="text-xl font-bold text-slate-900 mb-3">Control y Auditoría</h3>
                <p className="text-slate-600 leading-relaxed">Historial inmutable de ingresos y salidas. Control de turnos de empleados y registro de quién realizó cada cobro.</p>
              </div>
            </div>
          </div>
        </section>
            ...
            <div className="grid md:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <p className="text-lg text-slate-300 leading-relaxed mb-8">
                  Proporcionar a los dueños de parqueaderos una herramienta tecnológica accesible, segura y fácil de usar que optimice sus operaciones diarias, reduzca las pérdidas por evasión y mejore la experiencia tanto de sus empleados como de sus clientes finales.
                </p>
                <h2 className="text-3xl md:text-4xl font-bold mb-6">Nuestra Visión</h2>
                <p className="text-lg text-slate-300 leading-relaxed">
                  Convertirnos en el estándar de la industria para la gestión de parqueaderos en la región, impulsando la modernización del sector a través de innovación continua y un servicio al cliente excepcional.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-slate-800 p-6 rounded-3xl">
                  <div className="text-4xl font-bold text-indigo-400 mb-2">+50</div>
                  <div className="text-sm text-slate-400 font-medium uppercase tracking-wider">Parqueaderos</div>
                </div>
                <div className="bg-slate-800 p-6 rounded-3xl mt-8">
                  <div className="text-4xl font-bold text-emerald-400 mb-2">+10k</div>
                  <div className="text-sm text-slate-400 font-medium uppercase tracking-wider">Vehículos/Día</div>
                </div>
                <div className="bg-slate-800 p-6 rounded-3xl">
                  <div className="text-4xl font-bold text-blue-400 mb-2">99.9%</div>
                  <div className="text-sm text-slate-400 font-medium uppercase tracking-wider">Disponibilidad</div>
                </div>
                <div className="bg-slate-800 p-6 rounded-3xl mt-8">
                  <div className="text-4xl font-bold text-purple-400 mb-2">24/7</div>
                  <div className="text-sm text-slate-400 font-medium uppercase tracking-wider">Soporte</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <section id="pricing" className="py-24 bg-slate-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-slate-600 max-w-2xl mx-auto">Elige el plan que mejor se adapte al tamaño de tu operación. Sin contratos a largo plazo.</p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              ...
              {/* Pro Plan */}
              <div className="bg-indigo-600 rounded-3xl p-8 border border-indigo-500 shadow-xl shadow-indigo-200 transform md:-translate-y-4 flex flex-col relative">
        ...
        <section id="contact" className="py-24 bg-white">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-slate-900 mb-4">¿Tienes dudas? Contáctanos</h2>
              <p className="text-lg text-slate-600">Déjanos tus datos y nos comunicaremos contigo lo más pronto posible para resolver tus inquietudes o ayudarte con tu plan.</p>
            </div>
            
            <div className="bg-slate-50 p-8 rounded-3xl border border-slate-200 shadow-sm">
              <form action="https://formspree.io/f/xyzpjjdy" method="POST" className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <label htmlFor="name" className="block text-sm font-medium text-slate-700 mb-2">Nombre Completo</label>
                    <input type="text" id="name" name="name" required className="w-full px-4 py-3 rounded-xl border border-slate-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-all" placeholder="Ej. Juan Pérez" />
                  </div>
                  <div>
                    <label htmlFor="email" className="block text-sm font-medium text-slate-700 mb-2">Correo Electrónico</label>
                    <input type="email" id="email" name="email" required className="w-full px-4 py-3 rounded-xl border border-slate-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-all" placeholder="juan@ejemplo.com" />
                  </div>
                </div>
                
                <div>
                  <label htmlFor="phone" className="block text-sm font-medium text-slate-700 mb-2">Teléfono (Opcional)</label>
                  <input type="tel" id="phone" name="phone" className="w-full px-4 py-3 rounded-xl border border-slate-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-all" placeholder="+57 300 000 0000" />
                </div>

                <div>
                  <label htmlFor="subject" className="block text-sm font-medium text-slate-700 mb-2">Asunto</label>
                  <select id="subject" name="subject" required className="w-full px-4 py-3 rounded-xl border border-slate-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-all bg-white">
                    <option value="">Selecciona una opción...</option>
                    <option value="Información de Precios">Información de Precios</option>
                    <option value="Soporte Técnico">Soporte Técnico</option>
                    <option value="Demostración del Sistema">Demostración del Sistema</option>
                ...
                <div>
                  ...
                  <textarea id="message" name="message" rows={4} required className="w-full px-4 py-3 rounded-xl border border-slate-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-all resize-none" placeholder="¿En qué podemos ayudarte?"></textarea>
                </div>

                <button type="submit" className="w-full py-4 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-xl shadow-md transition-all hover:shadow-lg flex items-center justify-center gap-2">
                  <Mail size={20} />
                  Enviar Mensaje
                </button>
              </form>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li><a href="#about" className="hover:text-indigo-400 transition-colors">Nosotros</a></li>
                <li><a href="#pricing" className="hover:text-indigo-400 transition-colors">Precios</a></li>
                <li><Link href="/login" className="hover:text-indigo-400 transition-colors">Iniciar Sesión</Link></li>
              </ul>
            </div>
            <div>
