...
- **Corrección de la Columna Fee**: Se corrigió el error al registrar un ingreso manual retroactivo o forzado, ajustando la base de datos a `fee` y `total_charged` en lugar del campo ambiguo previo, permitiendo guardados limpios y evitando errores de cache de esquema.
