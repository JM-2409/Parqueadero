...
- **Alertas de Tiempo Excedido**: Se integró una configuración en el panel de administración que permite establecer un límite de horas. Los vehículos que superen este tiempo máximo se resaltarán con un borde y etiqueta de alerta (rojo) en el panel del operario.
